...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  return "<div class=\"post-list__header\">\n	<div class=\"post-list__header__title\">Lista de todos os membros do Centro de Investigação Saúde Pública</div>\n</div>";
  });
